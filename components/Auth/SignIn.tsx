...
import { RiLock2Line, RiMailAddLine, RiMailLine } from "react-icons/ri";
...
const SignIn = () => {
  ...
  const router = useRouter()
   ...
   const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
     ...
     } else if(typeof data.password !== "string" || typeof data.email !== "string") {
       throw new Error("Please enter a valid password or email")
     }
