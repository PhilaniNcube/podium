...
import { BrandType, Database, ImageObject, ProductType } from "../../../utils/database.d.types";
...
type FormSchemaType = z.infer<typeof BrandSchema>;

type ComponentProp = {
  brand: BrandType;
};

const Brand = ({ brand }: ComponentProp) => {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const uploadFiles = async (e: FormEvent<HTMLInputElement>) => {
    ...
    const onSubmit: SubmitHandler<FormSchemaType> = async (data) => {
      ...
      if(brandError) {
        toast.error(brandError.details)
      }
    };
    ...
    <Dashboard>
      <div className="p-8">
        <div className="bg-white border border-slate-200 rounded-xl">
          <div className="bg-gray-50 flex justify-start px-4 py-3 text-right sm:px-6">
            <Link
              href="/admin/brands"
